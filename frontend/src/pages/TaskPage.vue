...
import { taskStatusLabel, phases, connections, timestamp, message, taskFailureMessage } from '../presentation'
...
<template>
  ...
  <TaskRecoveryNotice v-if="state.task" :task="state.task" />
