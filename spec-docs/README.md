...
2026-09-12：V0.2-A 已交付于 `9012e26`，历史实现及 A01–A17 受控 17/17 证据见切片第 9 节。V0.2-B 从该提交核对并先同步规范投影，已实现实际工作许可/迟到写入保护和有限终态保存，B01–B10 受控验收通过，具体命令、回归和失败记录见第 10 节。V47 真实成功回归仍因凭据/环境缺失 BLOCKED，不宣称全部发布证据齐备；V0.3 未施工。
